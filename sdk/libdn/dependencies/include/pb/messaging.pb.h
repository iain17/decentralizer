...
#ifndef PROTOBUF_INCLUDED_pb_2fmessaging_2eproto
#define PROTOBUF_INCLUDED_pb_2fmessaging_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_pb_2fmessaging_2eproto 
...
namespace google {
namespace protobuf {
template<> ::pb::DNDirectMessageRequest* Arena::CreateMaybeMessage<::pb::DNDirectMessageRequest>(Arena*);
template<> ::pb::DNDirectMessageResponse* Arena::CreateMaybeMessage<::pb::DNDirectMessageResponse>(Arena*);
template<> ::pb::RPCDirectMessage* Arena::CreateMaybeMessage<::pb::RPCDirectMessage>(Arena*);
template<> ::pb::RPCReceiveDirectMessageRequest* Arena::CreateMaybeMessage<::pb::RPCReceiveDirectMessageRequest>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace pb {
...
class DNDirectMessageResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.DNDirectMessageResponse) */ {
 public:
  ...
  inline DNDirectMessageResponse* New() const final {
    return CreateMaybeMessage<DNDirectMessageResponse>(NULL);
  }

  DNDirectMessageResponse* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<DNDirectMessageResponse>(arena);
  }
...
class DNDirectMessageRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.DNDirectMessageRequest) */ {
 public:
  ...
  inline DNDirectMessageRequest* New() const final {
    return CreateMaybeMessage<DNDirectMessageRequest>(NULL);
  }

  DNDirectMessageRequest* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<DNDirectMessageRequest>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class RPCReceiveDirectMessageRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.RPCReceiveDirectMessageRequest) */ {
 public:
  ...
  inline RPCReceiveDirectMessageRequest* New() const final {
    return CreateMaybeMessage<RPCReceiveDirectMessageRequest>(NULL);
  }

  RPCReceiveDirectMessageRequest* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<RPCReceiveDirectMessageRequest>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class RPCDirectMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.RPCDirectMessage) */ {
 public:
  ...
  inline RPCDirectMessage* New() const final {
    return CreateMaybeMessage<RPCDirectMessage>(NULL);
  }

  RPCDirectMessage* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<RPCDirectMessage>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
#endif  // PROTOBUF_INCLUDED_pb_2fmessaging_2eproto
