...
func HandleMessage(conn net.Conn, connection_data *structs.ConnData, packet_data *structs.PacketData, np_server *NPServer) error {
	switch packet_data.Header.Type {
		 case 1000:
			return handlers.RPCHealthRequest(conn, connection_data, packet_data, np_server.Query_server.Listener)
		 case 1001:
			return handlers.RPCHealthReply(conn, connection_data, packet_data, np_server.Query_server.Listener)
		}
