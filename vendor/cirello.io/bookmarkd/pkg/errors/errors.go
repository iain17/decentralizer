...
// The types are:
//	*cli.Context
//		It detects the errors is being passed to urfave/cli handler, and
//		convert the returned error accordingly.
//	errors.Op
...
func E(args ...interface{}) error {
	...
	if isUrfaveCLI {
		return cli.NewExitError(e.Error(), int(e.Kind)+1)
	}
