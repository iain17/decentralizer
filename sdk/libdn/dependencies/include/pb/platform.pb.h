...
#ifndef PROTOBUF_INCLUDED_pb_2fplatform_2eproto
#define PROTOBUF_INCLUDED_pb_2fplatform_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_pb_2fplatform_2eproto 
...
namespace google {
namespace protobuf {
template<> ::pb::RPCHealthReply* Arena::CreateMaybeMessage<::pb::RPCHealthReply>(Arena*);
template<> ::pb::RPCHealthRequest* Arena::CreateMaybeMessage<::pb::RPCHealthRequest>(Arena*);
...
class RPCHealthRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.RPCHealthRequest) */ {
 public:
  ...
  inline RPCHealthRequest* New() const final {
    return CreateMaybeMessage<RPCHealthRequest>(NULL);
  }

  RPCHealthRequest* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<RPCHealthRequest>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class RPCHealthReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.RPCHealthReply) */ {
 public:
  ...
  inline RPCHealthReply* New() const final {
    return CreateMaybeMessage<RPCHealthReply>(NULL);
  }

  RPCHealthReply* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<RPCHealthReply>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
#endif  // PROTOBUF_INCLUDED_pb_2fplatform_2eproto
