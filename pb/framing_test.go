...
func TestWrite(t *testing.T) {
	...
	assert.Equal(t, []byte{0x8, 0x1, 0x10, 0xba, 0xa, 0x22, 0x10, 0x8, 0x1, 0x12, 0xc, 0x76, 0x65, 0x72, 0x79, 0x20, 0x6e, 0x69, 0x63, 0x65, 0x2e, 0x2e, 0x2e, '\n', '\r', '\n'}, w.data)
}

func TestRead(t *testing.T) {
	ibuf := bytes.NewBuffer([]byte{0x8, 0x1, 0x10, 0xba, 0xa, 0x22, 0x10, 0x8, 0x1, 0x12, 0xc, 0x76, 0x65, 0x72, 0x79, 0x20, 0x6e, 0x69, 0x63, 0x65, 0x2e, 0x2e, 0x2e, '\n', '\r', '\n'})
