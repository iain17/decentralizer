...
var (
	filter_Decentralizer_GetHealth_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_Decentralizer_GetHealth_0(ctx context.Context, marshaler runtime.Marshaler, client DecentralizerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_Decentralizer_GetHealth_0); err != nil {
